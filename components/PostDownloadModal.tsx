      ...
      <div className="bg-white rounded-2xl max-w-lg w-full p-8 relative animate-scale-in shadow-2xl">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            {t.postDownload.title}
          </h2>
          <p className="text-gray-600">
            {t.postDownload.subtitle}
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-200 rounded-xl p-4">
              <p className="text-sm font-semibold text-orange-900 mb-2">
                {t.postDownload.runningLow}
              </p>
              <p className="text-sm text-orange-700">
                {t.postDownload.runningLowDesc
                  .replace('{remaining}', String(remainingUploads))
                  .replace('{total}', String(totalLimit))}
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-fuchsia-50 border-2 border-purple-200 rounded-xl p-6">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">{t.postDownload.upgradePro}</h3>
                  <p className="text-sm text-gray-600">
                    {t.postDownload.upgradeProDesc}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-900 mb-1">{t.postDownload.loveCentyr}</h3>
                  <p className="text-sm text-gray-600 mb-3">
                    {t.postDownload.referralDesc} <span className="font-bold text-blue-600">{t.postDownload.referralCredits}</span>
                  </p>
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      {copied ? t.postDownload.copied : t.postDownload.copy}
                    </button>
                  </div>
                </div>
              </div>
