// Logo path data sourced from the simple-icons project (CC0 license, simpleicons.org)
...
export function EbayLogo({ size = 24, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function EtsyLogo({ size = 24, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export function ZalandoLogo({ size = 24, className }: LogoProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const STORE_LOGOS: StoreSpec[] = [
  { key: 'amazon', name: 'Amazon', brandColor: '#FF9900', Logo: AmazonLogo, width: 2000, height: 2000, marginPct: 5 },
  { key: 'ebay', name: 'eBay', brandColor: '#E53238', Logo: EbayLogo, width: 1600, height: 1600, marginPct: 10 },
