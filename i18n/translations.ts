...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    marketing: {
      hero: {
        badge: '20 hours by hand, now 10 minutes',
        title: 'Set your catalog standard once.',
        titleHighlight: 'Every product matches — and stays matched.',
        subtitle: 'Upload your whole catalog and get one standard on every photo — aligned, centered, sized, clean background, even lighting. New products auto-match the ones already there, and one click re-applies your standard to the entire catalog whenever it changes. Ready for Amazon, eBay, Etsy, Zalando and your own store.',
      ...
      features: {
        title: 'Not a photo. A standard.',
        subtitle: 'Align, standardize and keep your whole catalog consistent — even as you add new products.',
        f1Title: 'Uniform alignment',
        f1Desc: 'Every product centered, resized and aligned to the same standard, automatically, to each marketplace\'s exact specs.',
        f2Title: 'Whole catalogs in minutes',
        f2Desc: 'Upload hundreds of photos at once. They all come back identical in minutes — not hours by hand in Canva, not days from a freelancer.',
        f3Title: 'Your standard never drifts',
        f3Desc: 'Add a product today: it auto-matches the other 500 already done. Your catalog stays uniform over time, on its own.',
        f4Title: 'Change everything in one click',
        f4Desc: 'Change a margin or format? Re-process the whole catalog instantly. With Fiverr or by hand you start over — here it\'s one click.',
      },
      howItWorks: {
      ...
      testimonials: {
        badge: 'Built by a founder who lived the problem',
        title: 'Honest proof, not fake reviews',
        subtitle: 'No customer logos or testimonials here yet — just the product, working on your own catalog. Try your hardest products free and judge the before/after yourself.',
        t1Content: "The real problem isn't one nice photo — it's having a whole catalog match, and keeping it matched as you add products.",
        t1Result: '~200 products in ~10 min',
        t2Content: 'Your standard is saved and re-applied. New products auto-match the ones already there; one click re-does the whole catalog.',
        t2Result: 'Auto-match, no re-work',
        t3Content: 'Built for hard products — glass, jewelry, transparent, reflective — using BiRefNet, not a generic remover.',
        t3Result: 'Handles complex packaging',
        t4Content: 'Try your hardest products free and see the before/after on your own catalog before you pay anything.',
        t4Result: '30-day money-back',
        stat1Label: '~20 hours saved per catalog',
        stat2Label: 'Products, not stores',
        stat3Label: 'One reproducible standard',
        stat4Label: 'No fake reviews',
      },
      finalCta: {
        badge: 'Start processing in under 60 seconds',
        title: 'Your Catalog Uniform,',
        titleLine2: 'Today and Always',
        subtitle: 'Upload your whole catalog, get everything aligned in minutes. Add products tomorrow — they stay consistent on their own. Start free, no credit card required.',
  ...
  it: {
    ...
    marketing: {
      hero: {
        badge: '20 ore a mano, ora 10 minuti',
        title: 'Imposta lo standard del catalogo una volta.',
        titleHighlight: 'Ogni prodotto combacia — e resta così.',
        subtitle: 'Carica l\'intero catalogo e ottieni uno standard su ogni foto — allineamento, centratura, dimensione, sfondo pulito, luce uniforme. I nuovi prodotti si auto-allineano a quelli già presenti, e con un click ri-applichi lo standard a tutto il catalogo quando cambia. Pronto per Amazon, eBay, Etsy, Zalando e il tuo store.',
        ctaPrimary: 'Prova i tuoi prodotti più difficili gratis',
      ...
      features: {
        title: 'Non una foto. Uno standard.',
        subtitle: 'Allinea, uniforma e mantieni coerente tutto il catalogo — anche quando aggiungi nuovi prodotti.',
        f1Title: 'Allineamento uniforme',
        f1Desc: 'Ogni prodotto centrato, ridimensionato e allineato allo stesso standard, automatico, secondo le specifiche di ogni marketplace.',
        f2Title: 'Interi cataloghi in minuti',
        f2Desc: 'Carica centinaia di foto insieme. Escono tutte identiche in minuti — non ore a mano su Canva, non giorni da un freelancer.',
        f3Title: 'Lo standard non deriva mai',
        f3Desc: 'Aggiungi un prodotto oggi: matcha in automatico gli altri 500 già fatti. Il tuo catalogo resta uniforme nel tempo, da solo.',
        f4Title: 'Cambi tutto in un click',
        f4Desc: 'Cambi margine o formato? Ri-processi l\'intero catalogo all\'istante. Con Fiverr o a mano ricominci da zero — qui è un click.',
      },
      howItWorks: {
      ...
      testimonials: {
        badge: 'Costruito da un founder che ha vissuto il problema',
        title: 'Prove oneste, non recensioni finte',
        subtitle: 'Ancora nessun logo cliente o testimonial qui — solo il prodotto, che lavora sul tuo catalogo. Prova gratis i tuoi prodotti più difficili e giudica tu il before/after.',
        t1Content: "Il problema vero non è una bella foto — è avere un intero catalogo che combacia, e mantenerlo così quando aggiungi prodotti.",
        t1Result: '~200 prodotti in ~10 min',
        t2Content: 'Il tuo standard viene salvato e ri-applicato. I nuovi prodotti si auto-allineano a quelli già presenti; con un click rifai tutto il catalogo.',
        t2Result: 'Auto-match, zero rilavoro',
        t3Content: "Costruito per i prodotti difficili — vetro, gioielli, trasparenti, riflettenti — con BiRefNet, non un rimuovi-sfondo generico.",
        t3Result: 'Gestisce packaging complessi',
        t4Content: "Prova gratis i tuoi prodotti più difficili e vedi il before/after sul tuo catalogo prima di pagare.",
        t4Result: 'Rimborso 30 giorni',
        stat1Label: '~20 ore risparmiate per catalogo',
        stat2Label: 'Prodotti, non negozi',
        stat3Label: 'Uno standard riproducibile',
        stat4Label: 'Nessuna recensione finta',
      },
      finalCta: {
        badge: 'Inizia a elaborare in meno di 60 secondi',
        title: 'Il Tuo Catalogo Uniforme,',
        titleLine2: 'Oggi e Sempre',
        subtitle: "Carica l'intero catalogo, ottieni tutto allineato in minuti. Aggiungi prodotti domani: restano coerenti da soli. Inizia gratis, senza carta di credito.",
