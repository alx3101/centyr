...
export const translations: Record<Language, Translations> = {
  ...
  it: {
    ...
    upload: {
      ...
      newJob: 'Nuovo Job',
      newJobSubtitle: "Ogni caricamento crea un job — la nostra AI allinea ed elabora automaticamente le tue foto.",
      jobsRemaining: 'jobs rimanenti',
      whatIsJob: "Cos'è un job?",
      jobExplanation: "Un job è un batch di una o più immagini inviate alla nostra AI per l'elaborazione. Ogni job ha un nome, traccia il progresso in tempo reale e mantiene i risultati disponibili per il download nella dashboard.",
      stepUpload: 'Carica',
