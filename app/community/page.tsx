        ...
        <div className="bg-white/80 backdrop-blur-sm border-2 border-purple-100 rounded-2xl shadow-xl p-8 space-y-8 text-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              {(it ? [
                { icon: '💬', text: 'Forum di discussione su workflow, best practice e configurazioni' },
                { icon: '🎨', text: 'Galleria di output: ispirati ai risultati di altri utenti' },
                { icon: '🛠️', text: 'Integrations showcase: script, automazioni e connettori condivisi dalla community' },
                { icon: '📣', text: 'Canale diretto per feature request e feedback al team Centyr' },
                { icon: '🎓', text: 'Q&A moderato dal team per domande tecniche e casi d\'uso' },
              ] : [
                { icon: '💬', text: 'Discussion forums on workflows, best practices, and configurations' },
                { icon: '🎨', text: 'Output gallery: get inspired by other users\' results' },
                { icon: '🛠️', text: 'Integrations showcase: scripts, automations, and connectors shared by the community' },
                { icon: '📣', text: 'Direct channel for feature requests and feedback to the Centyr team' },
                { icon: '🎓', text: 'Team-moderated Q&A for technical questions and use cases' },
              ]).map(({ icon, text }) => (
          ...
          <div className="bg-purple-50 rounded-xl p-5 border border-purple-100 text-center">
            ...
            >
              {it ? 'Avvisami al lancio →' : 'Notify me at launch →'}
            </a>
          </div>
