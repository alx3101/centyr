        ...
        <div className="mt-8">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            ...
            <button
              ...
              className="w-full border-2 border-gray-200 rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-400 transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="w-full border-2 border-gray-200 rounded-lg px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 hover:border-gray-900 transition-colors flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
